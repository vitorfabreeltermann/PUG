...
public class Logo extends JPanel{
	...
	public static final Color TOPPER_COLOR_1 = new Color(0x20, 0x20, 0x20);
	public static final Color TOPPER_COLOR_2 = new Color(0x90, 0x0, 0x0);
	...
	public void paintComponent(Graphics g) {
		int currentFrame = timer.getCurrentFrame();
